...
describe('AdvertisementService', () => {
  ...
  describe('#findAll', () => {
    xit('should return all advertisements', () => {
      service
        .findAll()
  ...
  describe('#getLatestAdv', () => {
    xit('should always return an array of adv with lenght of two', () => {
      service.getLatestAdv().subscribe((arr) => {
        expect(arr.length).toBe(2)
      })
    })

    xit('should return adv with id=1, id=2, for first', () => {
      service.getLatestAdv().subscribe((arr) => {
    ...
    xit('should return adv with id=2, id=3, if the user goes forward', () => {
